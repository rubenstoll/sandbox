...
/**
 * Selects only files that are within <code>WEB-INF</code> directory and have
...
public class PropertyFileFilter implements FileFilter {
	...
	/**
	 * <p>
	 * Returns filename extension. Returns empty String if no extension is
	 * defined. E.g.:
	 * <ul>
	 * <li><code>myFile.dat</code>, returns <code>dat</code></li>
	 * <li><code>myFile.with.dots.properties</code>, returns
